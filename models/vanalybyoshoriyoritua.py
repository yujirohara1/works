...
## 実テーブル
class VAnalyByoshoRiyorituA(db.Model): 
    __tablename__ = "v_analy_byosho_riyoritu_a"
    ...
    nobe_byosho_kei    = db.Column(db.Numeric, primary_key=False) 
    riyoritu           = db.Column(db.Numeric, primary_key=False) 


class VAnalyByoshoRiyorituASchema(ma.SQLAlchemyAutoSchema):
      class Meta:
            model = VAnalyByoshoRiyorituA
            load_instance = True
