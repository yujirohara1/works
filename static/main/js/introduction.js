...
var a = '';
a = a + '  <div id="carouselExampleIndicators" class="carousel carousel-dark slide" data-bs-ride="carousel">  ';
...
a = a + '        <img src="../static/image/positive.png" class="d-block w-100" alt="...">  ';
a = a + '      </div>  ';
a = a + '      <div class="carousel-item">  ';
a = a + '        <img src="../static/image/negative.png" class="d-block w-100" alt="...">  ';
a = a + '      </div>  ';
a = a + '    </div>  ';
